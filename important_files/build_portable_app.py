...
def create_portable_package():
    ...
    output_dir = os.path.join(os.getcwd(), "Idle Scrape - Google Maps Scraper Portable")
    ...
    try:
        exe_name = "Idle Scrape - Google Maps Scraper.exe"
        ...
        with open(readme_path, "w") as f:
            f.write("""Idle Scrape - Google Maps Scraper
===========================

Cara Penggunaan:
1. Double-click pada file "Idle Scrape - Google Maps Scraper.exe"
...
def create_zip_package():
    ...
    try:
        output_dir = "Idle Scrape - Google Maps Scraper Portable"
        zip_name = "Idle Scrape - Google Maps Scraper Portable.zip"
...
if __name__ == "__main__":
    ...
    print("You can distribute 'Idle Scrape - Google Maps Scraper Portable.zip' to users.") 